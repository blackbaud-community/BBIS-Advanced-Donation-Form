        ...
        /*------------------------------------------- GLOBAL VARIABLE DECLARATION - SECTION END -------------------------------------------*/
            ...
            function GetEditorInformation(partId) {
                onEditorContentSuccess = function onSuccess(content) {
                    merchantAccountId = content.MerchantAccountID;
            ...
            /*************************************** HANDLE CHECKOUT EVENTS SECTION START ***************************************/
            ...
            function handleCheckoutLoaded() {
                if (!opened) {
                    ...
                    var tid = $('#paymentForm').find("input[name*='transactiontoken']").val();
            ...
            /*************************************** HANDLE CHECKOUT EVENTS SECTION END ***************************************/
            ...
            function PageLoad() {
                ...
                var t;
                part = $(".donationForm");
                var serverMonth = part.parents(".BBDonationApiContainer").attr("serverMonth") - 1,
                ...
                GetEditorInformation(partInstanceId);
